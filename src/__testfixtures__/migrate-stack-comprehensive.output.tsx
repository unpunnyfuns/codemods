...
import { color, radius } from '@hb-frontend/nordlys';
...
export function ComprehensiveExample() {
  return (
    <>
      ...
      <Stack direction='vertical' gap="md" style={styles.vstack0}>
        <SomeOtherComponent />
      </Stack>
      {/* Test marginX/marginY expansion */}
      <Stack direction='horizontal' gap="sm" style={styles.hstack0}>
        <SomeOtherComponent />
      </Stack>
      {/* Test flexbox props */}
