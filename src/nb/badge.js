...
const badgeConfig = {
  ...
  targetImport: '@hb-frontend/app/src/components/nordlys/Badge',
  targetName: 'Badge',
...
/**
 * Transform a single Badge element to Nordlys Badge
 *
...
function transformBadge(path, index, ctx) {
  ...
  // Pattern 3: Has text content → migrate to Nordlys Badge
