/**
 * TargetValidator - Validates against Nordlys design system constraints
 *
 * Checks if token values and prop usage are valid according to Nordlys rules.
 * This is target-level validation, specific to the Nordlys design system.
 *
 * Validates:
 * - Are space/radius tokens valid Nordlys tokens?
...
export class TargetValidator {
  ...
  /**
   * Validate a literal value against Nordlys constraints
