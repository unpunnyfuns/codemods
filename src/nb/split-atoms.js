...
// Atom components and their associated types (Avatar -> ['AvatarProps'])
const ATOMS = new Map([
...
// Resolve component name from import (Avatar/AvatarProps -> 'Avatar', useAuth -> null)
...
// Create import declarations from grouped atoms, preserving type imports
