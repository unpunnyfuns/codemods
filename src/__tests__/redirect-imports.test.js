...
describe('transforms/redirect-imports', () => {
...
export function MyComponent() {
  return (
    ...
    const actual = runTransform(input, {
      ...
      targetImport: '@source/common/src/components/native-base',
    })

    expect(actual).toContain("from '@source/common/src/components/native-base'")
    expect(actual).toContain('<Box>')
    expect(actual).toContain('<Button>')
  })

  it('redirects imports with trailing slash (shim-redirect case)', () => {
    const input = `import { Box, Button } from '@source/common/src/components'
import { Typography } from '@source/common/src/components/'
...
export function MyComponent() {
  return (
    ...
    const actual = runTransform(input, {
      sourceImport: '@source/common/src/components',
      targetImport: '@source/common/src/components/native-base',
    })
